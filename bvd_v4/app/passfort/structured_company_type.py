...
class StructuredCompanyType(BaseModel):
    ...
    def from_bvd(standardised_legal_form):
        ...
        try:
            structured_company_type = STRUCTURED_COMPANY_TYPE_MAP[
                standardised_legal_form.lower()
            ]
...
STRUCTURED_COMPANY_TYPE_MAP = {
    ...
    "partnerships": StructuredCompanyType(
        {"ownership_type": OwnershipType.PARTNERSHIP.value}
    ),
    "sole traders/proprietorships": StructuredCompanyType(
        {"ownership_type": OwnershipType.SOLE_PROPRIETORSHIP.value}
    ),
    "public authorities": StructuredCompanyType(
        {"is_public": True, "ownership_type": OwnershipType.OTHER.value}
    ),
    "non profit organisations": StructuredCompanyType(
        {"ownership_type": OwnershipType.ASSOCIATION.value}
    ),
    ...
    "other legal forms": StructuredCompanyType(
        {"ownership_type": OwnershipType.OTHER.value}
    ),
