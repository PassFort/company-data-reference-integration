...
mock_request = {
    'config': {},
    'credentials': {
        '_cls': 'passfort_data_structure.stage_config.onfido.OnfidoCredentialsNoToken',
        'token': sandbox_token
    },
    'input_data': {
                ...
                [
                    {
                        ...
                        'country': 'USA',
                        'formatted_address': ', 21, Fake street, Springfield, Springfield, TX, 42223',
                        'locality': 'Springfield',
                        'original_address': ', 21, Fake street, Springfield, Springfield, TX, 42223',
...
class EndToEndTests(unittest.TestCase):
    def test_success_correct_shape(self):
        ...
        self.assertIn('matches', json_data['output_data'])
        self.assertIn('config', json_data['output_data'])
