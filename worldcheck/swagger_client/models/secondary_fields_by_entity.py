...
class SecondaryFieldsByEntity(object):
    ...
    """
    swagger_types = {
        'secondary_fields_by_entity': 'dict(str, list[FieldDefinition])'
    }

    attribute_map = {
        'secondary_fields_by_entity': 'secondaryFieldsByEntity'
    }

    def __init__(self, secondary_fields_by_entity=None):  # noqa: E501
        """SecondaryFieldsByEntity - a model defined in Swagger"""  # noqa: E501

        self._secondary_fields_by_entity = None
        self.discriminator = None

        self.secondary_fields_by_entity = secondary_fields_by_entity

    @property
    def secondary_fields_by_entity(self):
        """Gets the secondary_fields_by_entity of this SecondaryFieldsByEntity.  # noqa: E501


        :return: The secondary_fields_by_entity of this SecondaryFieldsByEntity.  # noqa: E501
        :rtype: dict(str, list[FieldDefinition])
        """
        return self._secondary_fields_by_entity

    @secondary_fields_by_entity.setter
    def secondary_fields_by_entity(self, secondary_fields_by_entity):
        """Sets the secondary_fields_by_entity of this SecondaryFieldsByEntity.


        :param secondary_fields_by_entity: The secondary_fields_by_entity of this SecondaryFieldsByEntity.  # noqa: E501
        :type: dict(str, list[FieldDefinition])
        """
        if secondary_fields_by_entity is None:
            raise ValueError("Invalid value for `secondary_fields_by_entity`, must not be `None`")  # noqa: E501

        self._secondary_fields_by_entity = secondary_fields_by_entity
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecondaryFieldsByEntity):
            return False
