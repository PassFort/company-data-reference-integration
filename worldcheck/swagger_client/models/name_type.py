...
class NameType(object):
    ...
    PRIMARY = "PRIMARY"
    AKA = "AKA"
    AKAENHANCED = "AKAENHANCED"
    FKA = "FKA"
    DBA = "DBA"
    MAIDEN = "MAIDEN"
    LANG_VARIATION = "LANG_VARIATION"
    PREVIOUS = "PREVIOUS"
    VEHICLE_ID = "VEHICLE_ID"
    LOW_QUALITY_AKA = "LOW_QUALITY_AKA"
    NATIVE_AKA = "NATIVE_AKA"
    ...
    def __init__(self):  # noqa: E501
        """NameType - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NameType):
            return False
